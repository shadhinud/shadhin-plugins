...
class Skin_Current_Theme5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Current Theme5', 'shadhin-plugins' );
	}
	...
	public function register_layout_controls1( Widget_Base $widget ) {
		...
		$this->add_control(
			'leaf_image',
			[
				'label' => esc_html__( "Leaf Image", 'shadhin-plugins' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				"description" => esc_html__( "Upload the Leaf image", 'shadhin-plugins' ),
			]
		);
	...
	public function render() {
		...
		if (!is_wp_error($category) && !empty($category)) {
			...
			<div class="mh-product-category-current-theme5">
