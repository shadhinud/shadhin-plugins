 ...
 * @since 1.0.0
 */
class MH_Elementor_Image_With_Rotated_Text extends Widget_Base {
	public function __construct($data = [], $args = null) {
		parent::__construct($data, $args);
		$direction_suffix = is_rtl() ? '.rtl' : '';

		wp_register_style( 'mh-image-with-rotated-text-style', SHADHIN_PLUGINS_ASSETS_URI . '/css/widgets-core/image-with-rotated-text' . $direction_suffix . '.css' );
	}
	...
	public function get_name() {
		return 'mh-ele-image-with-rotated-text';
	}
	...
	public function get_style_depends() {
		return [ 'mh-image-with-rotated-text-style' ];
	}
