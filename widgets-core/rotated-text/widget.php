...
class MH_Elementor_Rotated_Text extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Rotated Text', 'shadhin-plugins' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Vertical Writing Mode", 'shadhin-plugins' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Textillate Animation on Text?", 'shadhin-plugins' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->start_controls_section(
			'placement',
			[
				'label' => esc_html__( 'Placement', 'shadhin-plugins' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			'color_typo',
			[
				'label' => esc_html__( 'Color/Typography', 'shadhin-plugins' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
	...
	protected function render() {
		...
		$html = shadhin_plugins_get_widgetcore_template_part( 'rotated-text', null, 'rotated-text/tpl', $settings, true );
