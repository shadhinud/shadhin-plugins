...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 2', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-info-box-style2', SHADHIN_PLUGINS_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin2' . $direction_suffix . '.css' );
