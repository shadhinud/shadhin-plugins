...
class Skin_style9 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/mh-ele-info-box/mh_general/after_section_end', [ $this, 'register_layout_controls1' ] );
	}
	...
	public function get_title() {
		return __( 'Skin - Style 9', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-info-box-style9', SHADHIN_PLUGINS_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin9' . $direction_suffix . '.css' );
