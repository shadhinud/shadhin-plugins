...
class Skin_style6 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 6', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-info-box-style6', SHADHIN_PLUGINS_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin6' . $direction_suffix . '.css' );
