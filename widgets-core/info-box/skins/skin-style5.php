...
class Skin_style5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 5', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-info-box-style5', SHADHIN_PLUGINS_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin5' . $direction_suffix . '.css' );
