...
class Skin_style7 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 7', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-info-box-style7', SHADHIN_PLUGINS_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin7' . $direction_suffix . '.css' );
