...
class Skin_Style3 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 3', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-info-box-style3', SHADHIN_PLUGINS_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin3' . $direction_suffix . '.css' );
