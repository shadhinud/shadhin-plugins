 ...
 * @since 1.0.0
 */
class MH_Elementor_Tabs extends Widget_Base {
	public function __construct($data = [], $args = null) {
		parent::__construct($data, $args);
		$direction_suffix = is_rtl() ? '.rtl' : '';

		wp_register_style( 'mh-tabs-style', SHADHIN_PLUGINS_ASSETS_URI . '/css/widgets-core/tabs' . $direction_suffix . '.css' );
	}
	...
	protected function render() {
		...
		$classes = array();
		$classes[] = 'mh-tabs';
		$classes[] = 'mh-tabs-horizontal-nav';
