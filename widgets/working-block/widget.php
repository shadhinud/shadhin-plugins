<?php
namespace Shadhinplugins\Widgets\WorkingBlock;
...
class MH_Elementor_WorkingBlock extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Working Block', 'shadhin-plugins' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'working_block_icons_options', [
				'label' => esc_html__( 'Working Block Items', 'shadhin-plugins' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Working Items", 'shadhin-plugins' ),
