...
class Skin_Style8 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style8', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'team-block-style8', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/team-block/team-block-style8' . $direction_suffix . '.css' );
