...
class Skin_Style9 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style9', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'team-block-style9', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/team-block/team-block-style9' . $direction_suffix . '.css' );
