...
class Skin_Style4 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/mh-ele-team-block/mh_general/after_section_end', [ $this, 'register_layout_controls' ] );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'team-block-style4', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/team-block/team-block-style4' . $direction_suffix . '.css' );
