...
class Skin_Cursor_Floating_Info extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Cursor Floating Info', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-cursor-floating-info', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/service-block/service-block-cursor-floating-info' . $direction_suffix . '.css' );
