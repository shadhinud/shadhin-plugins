...
class Skin_Style6 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style6', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/service-block/service-block-style6' . $direction_suffix . '.css' );
		wp_register_script( 'service-block-style6', SHADHIN_PLUGINS_ASSETS_URI . '/js/widgets/service-block6.js', array( 'jquery' ), false, true );
