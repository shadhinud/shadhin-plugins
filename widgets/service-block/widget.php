<?php
namespace Shadhinplugins\Widgets\ServiceBlock;
 ...
 * @since 1.0.0
 */
class MH_Elementor_ServiceBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		parent::__construct($data, $args);
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			$direction_suffix = is_rtl() ? '.rtl' : '';
			wp_enqueue_style( 'mh-service-block-loader', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/service-block/service-block-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Service Block', 'shadhin-plugins' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'service_icons_options', [
				'label' => esc_html__( 'Service Items', 'shadhin-plugins' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Service Icon Section', 'shadhin-plugins' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$repeater->add_control(
			'icon_type',
			[
				'label' => esc_html__( "Service Icon Type", 'shadhin-plugins' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
		...
		$repeater->add_control(
			'service_icon_image',
			[
				'label' => esc_html__( "Icon Type - Image", 'shadhin-plugins' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Icon Type - Image (Hover)", 'shadhin-plugins' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'description' => esc_html__( "This image will be shown on the top of the pricing table", 'shadhin-plugins' ),
				'condition' => [
					'icon_type' => array('image')
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Icon Type - Image Size", 'shadhin-plugins' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => shadhin_plugins_get_available_image_sizes(),
				'default' => 'full',
				'condition' => [
		...
		$repeater->add_responsive_control(
			...
			[
				'label' => esc_html__( "Icon Image Custom Width", 'shadhin-plugins' ),
		...
		$this->add_control(
			'display_type', [
				...
				'options' => [
					...
					'basic2'  =>  esc_html__( 'Basic2', 'shadhin-plugins' ),
					'creative-style1'  =>  esc_html__( 'Creative Style1', 'shadhin-plugins' )
				],
				'default' => 'grid'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'GSAP Pin Settings', 'shadhin-plugins' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'mh_gsap_pin', [
				'label' => esc_html__( "Enable GSAP Pin", 'shadhin-plugins' ),
	...
	protected function render() {
		...
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'service-block-style1', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/service-block/service-block-style1' . $direction_suffix . '.css' );
