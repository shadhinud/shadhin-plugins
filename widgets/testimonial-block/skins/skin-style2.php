...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-testimonial-block-style2', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/testimonial-block/testimonial-block-style2' . $direction_suffix . '.css' );
