...
class Skin_Style3 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-award-block-skin-style3', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/award-block/award-block-skin-style3' . $direction_suffix . '.css' );
		wp_register_script( 'award-block3', SHADHIN_PLUGINS_ASSETS_URI . '/js/widgets/award-block3.js', array( 'jquery' ), false, true );
