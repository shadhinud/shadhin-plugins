...
class Skin_Style5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Theme Button Style5', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-theme-button-style5', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/theme-button/theme-button-style5' . $direction_suffix . '.css' );
