...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Theme Button Style2', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-theme-button-style2', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/theme-button/theme-button-style2' . $direction_suffix . '.css' );
