<?php
namespace Shadhinplugins\Widgets\PricingBlock;
...
class TM_Elementor_PricingBlock extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Pricing Block', 'shadhin-plugins' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'pricing_icons_options', [
				'label' => esc_html__( 'Pricing Items', 'shadhin-plugins' ),
		...
		$repeater->add_control(
			'image_position', [
				'label' => esc_html__( "Image/Icon Position", 'shadhin-plugins' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
			...
			[
				...
				'default' => [
					[
						...
						'price' => esc_html__( '$20.00', 'shadhin-plugins' ),
					],
					[
	...
	protected function render() {
		...
		$settings['holder_id'] = shadhin_get_isotope_holder_ID('pricing-block');

		$settings['settings'] = $settings;


		//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
		$html = shadhin_plugins_get_shortcode_template_part( 'pricing', $settings['display_type'], 'pricing-block/tpl', $settings, true );
