...
class Skin_Style11 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style11', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-features-block-style11', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/features-block/features-block-style11' . $direction_suffix . '.css' );
