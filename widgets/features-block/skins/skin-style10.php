...
class Skin_Style10 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style10', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-features-block-style10', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/features-block/features-block-style10' . $direction_suffix . '.css' );
