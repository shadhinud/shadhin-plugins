...
class Skin_Style12 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style12', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-features-block-style12', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/features-block/features-block-style12' . $direction_suffix . '.css' );
