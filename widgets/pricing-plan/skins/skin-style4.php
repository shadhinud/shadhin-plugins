...
class Skin_Pricing_Style4 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Pricing Style4', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-pricing-skin-style4', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/pricing-plan/pricing-skin-style4' . $direction_suffix . '.css' );
