...
?>
<div class="tm-sc-countdown-timer final-countdown countdown-timer-current-style countdown-timer-default <?php if( !empty($classes) ) echo esc_attr(implode(' ', $classes)); ?>">
