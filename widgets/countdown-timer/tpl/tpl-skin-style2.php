...
?>
<div class="mh-sc-countdown-timer final-countdown countdown-timer-current-style countdown-timer-style2 <?php if( !empty($classes) ) echo esc_attr(implode(' ', $classes)); ?>">
