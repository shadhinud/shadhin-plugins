...
class Skin_Style3 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-counter-block-style3', SHADHIN_PLUGINS_ASSETS_URI . '/css/shortcodes/counter-block/counter-block-style3' . $direction_suffix . '.css' );
		...
		$html = shadhin_plugins_get_shortcode_template_part( 'counter-skin-style3', null, 'counter-block/tpl', $settings, true );
