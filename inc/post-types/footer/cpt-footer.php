<?php
namespace Shadhinplugins\CPT\Footer;
 ...
 * Singleton class
 * class CPT_Footer
 * @package Shadhinplugins\CPT\Footer;
 */
final class CPT_Footer implements Lib\Shadhin_plugins_Interface_PostType {
	...
	private function __construct() {
		$this->ptSingularName = esc_html__( 'Parts - Footer', 'shadhin-plugins' );
	...
	public function customColumnsSettings( $columns ) {
		...
		$columns = array(
			...
			'active-footer'	=> esc_html__( 'Currently Active Footer', 'shadhin-plugins' ),
