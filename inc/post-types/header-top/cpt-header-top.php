<?php
namespace Shadhinplugins\CPT\HeaderTop;
 ...
 * Singleton class
 * class CPT_HeaderTop
 * @package Shadhinplugins\CPT\HeaderTop;
 */
final class CPT_HeaderTop implements Lib\Shadhin_plugins_Interface_PostType {
	...
	private function __construct() {
		$this->ptSingularName = esc_html__( 'Parts - Header Top', 'shadhin-plugins' );
	...
	public function customColumnsSettings( $columns ) {
		...
		$columns = array(
			...
			'active-headertop'	=> esc_html__( 'Currently Active Header Top', 'shadhin-plugins' ),
