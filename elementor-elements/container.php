...
class Shadhin_plugins_Container_Handler {
    ...
    public function extend_elementor_gsap_scroll_fixed_options( $element ){
        ...
        $element->start_controls_section(
            ...
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . __('TM GSAP Pin Scroll Fixed', 'shadhin-plugins'),
    ...
    public function render_curve_bg_options( $section, $args ) {
        $section->start_controls_section(
            'tm_curve_bg_options',
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - Curve BG Options', 'shadhin-plugins' ),
                'tab'   => \Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        $section->add_control(
    ...
    public function register_controls_custom_width($section, $args) {
        ...
        $section->start_controls_section(
            ...
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - Container Custom Width', 'shadhin-plugins' ),
                'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        $section->add_responsive_control(
    ...
    public function bg_move_effect_options( $section, $args ) {
        $section->start_controls_section(
            ...
            [
                'label' => TM_ELEMENTOR_WIDGET_BADGE . esc_html__( 'Mascot - BG Gsap Clip Path Effect', 'shadhin-plugins' ),
                'tab'   => \Elementor\Controls_Manager::TAB_LAYOUT,
            ]
        );
        $section->add_control(
