...
class Skin_Style_Current_Theme1 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-project-skin-current-theme1', SHADHIN_PLUGINS_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme1' . $direction_suffix . '.css' );

		wp_enqueue_script( 'mh-projects-block-script', SHADHIN_PLUGINS_ASSETS_URI . '/js/cpt/project-block.js', array('jquery'), false, true );
