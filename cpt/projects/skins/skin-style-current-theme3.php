...
class Skin_Style_Current_Theme3 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme3', 'shadhin-plugins' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'mh-project-skin-current-theme3', SHADHIN_PLUGINS_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme3' . $direction_suffix . '.css' );
		wp_enqueue_script( 'mh-project-block-bg-image', SHADHIN_PLUGINS_ASSETS_URI . '/js/cpt/project-block-bg-image.js', array('jquery'), false, true );
